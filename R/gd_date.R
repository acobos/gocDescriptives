...
#'
#' @param x The date variable to be described. Should be an object of one of the 
#' following classes: \code{c("Date", "POSIXlt", "POSIXct", "POSIXt")}.
#' @param date_format Optional. If specified, should ba a valid date format. See
#' the Details section in \code{\link[base]{?strptime}} for more details.
#'
...
#'
#' # Month as number, and day without leading space for single digit numbers
